...
signup_tag: Art  
---
{% include img.liquid img="img/doodleverse/banner2.jpeg" %}
...
It’s a SOLD OUT collection of 101 unique illustrated an animated NFTs on the Avalanche blockchain. You can view the collection [on Joepegs](https://heyrich.net/ddv) where you can pick up pieces for sale.
...
{% include img.liquid img="img/doodleverse/grid-1.jpg" caption="A few Doodleverse pieces" %}
{% include img.liquid img="img/doodleverse/grid-2.jpg" caption="Some more Doodleverse pieces" %}
{% include img.liquid img="img/doodleverse/grid-3.jpg" caption="And some more of The Doodleverse" %}

The Doodleverse was my first collection on the Avalanche blockchain. It started off as a [100 Day Project](https://heyrich.net/the-perfect-100-day-project-book/) where I created one piece a day. I ended up working on other collections during that 100 Day Project and carried on The Doodleverse well after my 100 Day project had ended.

For all things Doodleverse, follow me on [Twitter.](https://heyrich.net/twitter)